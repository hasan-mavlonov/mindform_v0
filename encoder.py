...
Produces 384-dimensional embeddings used to detect recurring experiences
(memory.py cosine similarity). Accepts either a single string or a list of strings
